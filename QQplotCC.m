function [CC,Sig_CC] = QQplotCC(group,alpha)
...
segments=length(group) + 1;

z_vals=norminv(linespace(0,1,segments),nanmean(group),nanstd(group));

CC=corrc([group, z_vals]); 
...
alpha01=[8299 8801 9126 9269 9410 9479 9538 9599 9632 9671 9695 9720 9771 9822 9879 9905 9935]'.*1e-3; 
alpha05=[8788 9198 9389 9508 9591 9652 9682 9726 9749 9768 9787 9801 9838 9873 9913 9931 9953]'.*1e-3;
alpha1=[9032 9351 9503 9604 9665 9715 9740 9771 9792 9809 9822 9836 9866 9895 9928 9942 9960]'.*1e-3;
samplesize=[5:5:60, 75 100 450 200 300]';

eval(sprintf('label=%s;',label{find(gdalpha)}));
Sig_CC=interp1(samplesize,label,(segments-1));
